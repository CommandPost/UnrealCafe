...
The current Unreal Cafe **icon** is just a modified version of the Resolve Cafe icon, designed by the amazing [Matthew Skiles](https://matthewskiles.com){target="_blank"}. We'll make a new one soon!
