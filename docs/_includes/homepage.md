==- :icon-bookmark: Make Unreal Cafe your Home Page
+++ Safari
...
3. Next to **Homepage** enter: `https://unreal.cafe`.
+++ Chrome
...
3. Select your current homepage, then, enter: `https://unreal.cafe`.
+++ Firefox
...
4. Click **Enter a URL**. Then, type: `https://unreal.cafe`.
+++ Internet Explorer
1. In the menu bar on the top of your browser, click **Tools**.
2. Select **Internet Options**.
3. Click the **General** tab.
4. Under "Home page," enter: `https://unreal.cafe`, click OK and restart your browser.
+++
===